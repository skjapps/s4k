...
void ControlSchemeSelect() {
  ...
  // Display the mode graphics
  ControlSchemeSelectScreen(gamepadControlScheme);
  ...
  if (bleGamepad.isConnected())
  {
    ...
    if(gamepadControlScheme == 2) {
      ...
      if((inputsReleased[4] == 1) && (!inputReleaseTime)) {
        // If the hold time was longer than 200ms = B
        if (inputsHoldTime[4] >= 200) {
          // Press B (?)
    ...
    // All in one?
    bleGamepad.setLeftThumb((16384 + (inputs[0] * -16384) + (inputs[1] * 16383)), (16384 + (inputs[3] * -16384) + (inputs[2] * 16383)));
...
void ControlSchemeSelectScreen(int Mode) {
