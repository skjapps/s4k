...
void setup() {
  ...
  // Set up event handler for BLE events
  BLE.setEventHandler(BLEConnected, blePeripheralConnected);
  BLE.setEventHandler(BLEDisconnected, blePeripheralDisconnected);
}
...
// Event handler for BLE connection
void blePeripheralConnected(BLEDevice central) {
  isConnected = true;
  Serial.println("Connected to central device");
  // Start pairing process if needed
...
void blePeripheralDisconnected(BLEDevice central) {
  isConnected = false;
